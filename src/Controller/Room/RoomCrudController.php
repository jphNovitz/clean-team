...
class RoomCrudController extends AbstractCrudController
{
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            //AssociationField::new('users')->setLabel('Personnes'),
            CollectionField::new('users')->addCssClass('hide'),
        ];
    }
    ...
    public function configureActions(Actions $actions): Actions
    {
       ...
       //parent::configureActions($actions); // TODO: Change the autogenerated stub

        $addRoom = Action::new('addRoom', 'Ajouter', 'fa fa-envelope')
