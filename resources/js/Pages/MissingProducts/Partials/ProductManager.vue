    ...
    <JetActionSection class="mt-10 sm:mt-0">
      ...
      <template #content>
        ...
        <div class="w-full flex md:table md:w-full md:border-collapse rounded-sm border-b shadow-xl overflow-hidden p-0 ">
          <div class="hidden md:table-header-group bg-main text-headline dark:bg-gray-800 dark:text-main">
          ...
          <div class="w-full flex flex-col md:table-row-group">
            <div v-for="product in $page.props.initialProducts" :key="product.id"
                 ...
                 :class="{'odd:bg-main dark:odd:bg-gray-800' : showOddColor, 'border-l-2 border-gray-400 rounded-l-md' : product.type_id === 1}, {'border-l-2 border-tertiary rounded-l-md' : product.type_id === 2}">
