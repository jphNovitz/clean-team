...
<template>
    <div class="w-full flex justify-between my-4">
        ...
        <Button class="rounded-full" @click.prevent="$emit('showAddModal')">
    ...
    <div class="w-full flex md:table md:w-full md:border-collapse rounded-md border-b shadow-xl overflow-hidden p-0 ">
